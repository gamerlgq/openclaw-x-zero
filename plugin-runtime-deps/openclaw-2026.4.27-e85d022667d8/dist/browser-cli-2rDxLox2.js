...
import { t as shouldEagerRegisterSubcommands } from "./command-registration-policy-C0qLofS8.js";
import { t as addGatewayClientOptions } from "./gateway-rpc-C75nvMsR.js";
import { t as formatHelpExamples } from "./help-format-CmO6sKiH.js";
import { i as registerCommandGroups } from "./register-command-groups-C8J96v2h.js";
import "./cli-runtime-CNGqumvx.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-Dnqm6gba.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-DkZeLvz_.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-DPGTKgb9.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-D4t1O--P.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-xFqS84VB.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-BWFbO_o_.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
