...
import { c as readErrorName, i as formatErrorMessage } from "./errors-g8SYDTCe.js";
import { l as toSafeImportPath } from "./bundled-plugin-metadata-VxOxTVqO.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-Buswj6xX.js";
...
import { i as failTaskRunByRunId, r as createRunningTaskRun, s as setDetachedTaskDeliveryStatusByRunId, t as completeTaskRunByRunId } from "./detached-task-runtime-CSPIY7Xg.js";
import { r as callGateway } from "./call-xuTtjcDL.js";
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-ClHWRFG8.js";
import { A as subagentRuns, C as SUBAGENT_ENDED_OUTCOME_ERROR, D as SUBAGENT_ENDED_REASON_ERROR, E as SUBAGENT_ENDED_REASON_COMPLETE, O as SUBAGENT_ENDED_REASON_KILLED, S as resolveSubagentSessionStatus, T as SUBAGENT_ENDED_OUTCOME_TIMEOUT, a as countActiveRunsForSessionFromRuns, b as getSubagentSessionRuntimeMs, c as getSubagentRunByChildSessionKeyFromRuns, d as listRunsForControllerFromRuns, i as countActiveDescendantRunsFromRuns, k as SUBAGENT_TARGET_KIND_SUBAGENT, n as persistSubagentRunsToDisk, r as restoreSubagentRunsFromDisk, s as countPendingDescendantRunsFromRuns, t as getSubagentRunsSnapshotForRead, u as listDescendantRunsForRequesterFromRuns, v as isStaleUnendedSubagentRun, w as SUBAGENT_ENDED_OUTCOME_KILLED, x as getSubagentSessionStartedAt } from "./subagent-registry-state-rHSh8WB7.js";
import { t as registerPendingSpawnedChildrenQuery } from "./pending-spawn-query-_uj1v9nJ.js";
import "./subagent-announce-queue-Du8Rh_2z.js";
import { a as isSilentReplyText } from "./tokens-BIJuzXU-.js";
import { u as withSubagentOutcomeTiming } from "./subagent-announce-output-DIRh3AwB.js";
import { l as retireSessionMcpRuntimeForSessionKey } from "./pi-bundle-mcp-runtime-BZXzXJCi.js";
import "./pi-bundle-mcp-tools-DcJhmfN5.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-mwLjTEYN.js";
...
async function loadCleanupBrowserSessionsForLifecycleEnd$1() {
	browserCleanupPromise$1 ??= import("./browser-lifecycle-cleanup-CaWh7nfg.js");
...
async function loadSubagentAnnounceModule() {
	subagentAnnouncePromise ??= import("./subagent-announce-DcbUkOK2.js");
	return await subagentAnnouncePromise;
}
async function loadCleanupBrowserSessionsForLifecycleEnd() {
	browserCleanupPromise ??= import("./browser-lifecycle-cleanup-CaWh7nfg.js");
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-1VhwkuzH.js").then(({ scheduleOrphanRecovery }) => {
