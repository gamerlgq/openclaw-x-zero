...
import { t as PLUGIN_REGISTRY_STATE } from "./runtime-state-DfdlNmk0.js";
import { l as onAgentEvent } from "./agent-events-Buswj6xX.js";
import { i as dispatchPluginAgentEventSubscriptions, n as clearPluginHostRuntimeState } from "./host-hook-runtime-kNvFynLC.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-DDnhjysS.js")]);
