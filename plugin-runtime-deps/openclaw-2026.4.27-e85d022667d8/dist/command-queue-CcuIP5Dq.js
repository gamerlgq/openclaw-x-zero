...
import { i as logLaneEnqueue, r as logLaneDequeue, t as diagnosticLogger } from "./diagnostic-runtime-CIzj_PYg.js";
...
*/
function resetCommandQueueStateForTest() {
	const queueState = getQueueState();
	queueState.gatewayDraining = false;
	queueState.lanes.clear();
	for (const waiter of Array.from(queueState.activeTaskWaiters)) resolveActiveTaskWaiter(waiter, { drained: true });
...
//#endregion
export { enqueueCommandInLane as a, getTotalQueueSize as c, resetCommandQueueStateForTest as d, setCommandLaneConcurrency as f, enqueueCommand as i, markGatewayDraining as l, GatewayDrainingError as n, getActiveTaskCount as o, waitForActiveTasks as p, clearCommandLane as r, getQueueSize as s, CommandLaneClearedError as t, resetAllLanes as u };
