...
import { i as inspectPathPermissions, n as formatPermissionDetail, r as formatPermissionRemediation } from "./audit-fs-BIdj7WRc.js";
import { n as resolveGatewayAuth } from "./auth-resolve-DSnijpPx.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-C6F-NnIG.js";
...
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-DetSLGQ0.js";
import { i as resolveSandboxConfigForAgent } from "./config-BPkEMfMR.js";
import { u as isInterpreterLikeAllowlistPattern } from "./exec-approvals-allowlist-BYLh3KqG.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-5DS2qWOn.js";
import { l as loadExecApprovals } from "./exec-approvals-CvfDEUzk.js";
import { n as collectCoreInsecureOrDangerousFlags, t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-B9RufMD3.js";
import { t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-D4KhAMb0.js";
import path from "node:path";
import { isIP } from "node:net";
//#region src/security/audit-deep-code-safety.ts
let auditDeepModulePromise;
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-9xNDF89X.js");
