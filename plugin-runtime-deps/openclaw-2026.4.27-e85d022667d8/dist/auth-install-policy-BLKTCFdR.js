...
import { t as collectDurableServiceEnvVars } from "./state-dir-dotenv--asxJdnR.js";
...
import { a as resolveGatewayProgramArguments, i as OPENCLAW_WRAPPER_ENV_KEY, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, s as resolveOpenClawWrapperPath, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DLO7tR7W.js";
import { c as formatManagedServiceEnvKeys, d as readManagedServiceEnvKeysFromEnvironment, f as writeManagedServiceEnvKeysToEnvironment, h as buildServiceEnvironment } from "./runtime-paths-BEIat-2M.js";
import { n as discoverConfigSecretTargets } from "./target-registry-DOBQeKjE.js";
...
function loadDaemonInstallAuthProfileSourceRuntime() {
	daemonInstallAuthProfileSourceRuntimePromise ??= import("./daemon-install-auth-profiles-source.runtime-DalXfx8C.js");
	return daemonInstallAuthProfileSourceRuntimePromise;
}
function loadDaemonInstallAuthProfileStoreRuntime() {
	daemonInstallAuthProfileStoreRuntimePromise ??= import("./daemon-install-auth-profiles-store.runtime-cvwTw_KK.js");
