...
import { S as resolveDefaultAgentId, g as listAgentEntries, n as resolveAgentEffectiveModelPrimary } from "./agent-scope-RNt6KatQ.js";
...
import { i as resolveOpenClawReferencePaths, n as OPENCLAW_SOURCE_URL, t as OPENCLAW_DOCS_URL } from "./docs-path-DVJW8JaL.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-Ze4iYCaI.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
