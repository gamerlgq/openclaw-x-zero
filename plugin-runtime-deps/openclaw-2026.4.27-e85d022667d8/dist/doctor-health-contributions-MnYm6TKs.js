...
async function runGatewayConfigHealth(ctx) {
	...
	const { hasAmbiguousGatewayAuthModeConfig } = await import("./auth-mode-policy-BSXYD69M.js");
	const { note } = await import("./note-4LHU8BLf.js");
...
async function runAuthProfileHealth(ctx) {
	const { maybeRepairLegacyFlatAuthProfileStores } = await import("./doctor-auth-flat-profiles-CPj7PWHt.js");
	const { maybeRepairLegacyOAuthProfileIds } = await import("./doctor-auth-legacy-oauth-DBLBssGW.js");
	const { noteAuthProfileHealth, noteLegacyCodexProviderOverride } = await import("./doctor-auth-DKSW8zhA.js");
	const { buildGatewayConnectionDetails } = await import("./call-Ze4iYCaI.js");
	const { note } = await import("./note-4LHU8BLf.js");
...
async function runGatewayAuthHealth(ctx) {
	...
	const { note } = await import("./note-4LHU8BLf.js");
	const { randomToken } = await import("./onboard-helpers-COP9ZGBo.js");
...
async function runClaudeCliHealth(ctx) {
	const { noteClaudeCliHealth } = await import("./doctor-claude-cli-BAamjDeP.js");
	noteClaudeCliHealth(ctx.cfg);
}
async function runLegacyStateHealth(ctx) {
	const { detectLegacyStateMigrations, runLegacyStateMigrations } = await import("./doctor-state-migrations-D3WQxFub.js");
	const { note } = await import("./note-4LHU8BLf.js");
...
async function runLegacyPluginManifestHealth(ctx) {
	const { maybeRepairLegacyPluginManifestContracts } = await import("./doctor-plugin-manifests-ws3ma4l3.js");
...
async function runPluginRegistryHealth(ctx) {
	const { maybeRepairPluginRegistryState } = await import("./doctor-plugin-registry-wjVcqzGP.js");
...
async function runBundledPluginRuntimeDepsHealth(ctx) {
	const { maybeRepairBundledPluginRuntimeDeps } = await import("./doctor-bundled-plugin-runtime-deps-Bss4_J7w.js");
...
async function runSandboxHealth(ctx) {
	const { maybeRepairSandboxImages, noteSandboxScopeWarnings } = await import("./doctor-sandbox-BJqz41qR.js");
...
async function runGatewayServicesHealth(ctx) {
	const { maybeRepairGatewayServiceConfig, maybeScanExtraGatewayServices } = await import("./doctor-gateway-services-CoRteWrM.js");
	const { noteMacLaunchAgentOverrides, noteMacLaunchctlGatewayEnvOverrides } = await import("./doctor-platform-notes-BVMIYiT8.js");
...
async function runStartupChannelMaintenanceHealth(ctx) {
	const { maybeRunDoctorStartupChannelMaintenance } = await import("./doctor-startup-channel-maintenance-DvIxwwwz.js");
...
async function runSecurityHealth(ctx) {
	const { noteSecurityWarnings } = await import("./doctor-security-lsCllwE6.js");
	await noteSecurityWarnings(ctx.cfg);
}
async function runBrowserHealth(ctx) {
	const { noteChromeMcpBrowserReadiness } = await import("./doctor-browser-QXCkOMh6.js");
	await noteChromeMcpBrowserReadiness(ctx.cfg);
}
async function runOpenAIOAuthTlsHealth(ctx) {
	const { noteOpenAIOAuthTlsPrerequisites } = await import("./oauth-tls-preflight-BkDkCsLG.js");
...
async function runHooksModelHealth(ctx) {
	...
	const { DEFAULT_MODEL, DEFAULT_PROVIDER } = await import("./defaults-BPpSi2ps.js");
	const { loadModelCatalog } = await import("./model-catalog-BfBjZIMO.js");
	const { getModelRefStatus, resolveConfiguredModelRef, resolveHooksGmailModel } = await import("./model-selection-D1YmojuQ.js");
	const { note } = await import("./note-4LHU8BLf.js");
...
async function runSystemdLingerHealth(ctx) {
	...
	const { resolveGatewayService } = await import("./service-WZ3ydGny.js");
	const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-MoXFWh1s.js");
	const { note } = await import("./note-4LHU8BLf.js");
...
async function runWorkspaceStatusHealth(ctx) {
	const { noteWorkspaceStatus } = await import("./doctor-workspace-status-AqxVd1Gy.js");
	noteWorkspaceStatus(ctx.cfg);
}
async function runBootstrapSizeHealth(ctx) {
	const { noteBootstrapFileSize } = await import("./doctor-bootstrap-size--Ac9kVON.js");
	await noteBootstrapFileSize(ctx.cfg);
}
async function runShellCompletionHealth(ctx) {
	const { doctorShellCompletion } = await import("./doctor-completion-9-9bC0rQ.js");
...
async function runGatewayHealthChecks(ctx) {
	const { checkGatewayHealth, probeGatewayMemoryStatus } = await import("./doctor-gateway-health-BrYnbXw7.js");
...
async function runMemorySearchHealthContribution(ctx) {
	const { maybeRepairMemoryRecallHealth, noteMemoryRecallHealth, noteMemorySearchHealth } = await import("./doctor-memory-search-DmG6JKKC.js");
...
async function runDevicePairingHealth(ctx) {
	const { noteDevicePairingHealth } = await import("./doctor-device-pairing-DVhJqZd3.js");
...
async function runGatewayDaemonHealth(ctx) {
	const { maybeRepairGatewayDaemon } = await import("./doctor-gateway-daemon-flow-QfCcL43d.js");
...
async function runWriteConfigHealth(ctx) {
	const { formatCliCommand } = await import("./command-format-BL3wkhq1.js");
	const { applyWizardMetadata } = await import("./onboard-helpers-COP9ZGBo.js");
	const { CONFIG_PATH, replaceConfigFile } = await import("./config/config.js");
	const { logConfigUpdated } = await import("./logging-klncKNIr.js");
...
async function runWorkspaceSuggestionsHealth(ctx) {
	...
	const { resolveAgentWorkspaceDir, resolveDefaultAgentId } = await import("./agent-scope-BjAlNuVl.js");
	const { noteWorkspaceBackupTip } = await import("./doctor-state-integrity-u9bph3sG.js");
	const { MEMORY_SYSTEM_PROMPT, shouldSuggestMemorySystem } = await import("./doctor-workspace-DSR9PPGW.js");
	const { note } = await import("./note-4LHU8BLf.js");
