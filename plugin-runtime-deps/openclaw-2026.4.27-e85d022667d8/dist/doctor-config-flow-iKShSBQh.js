...
import { r as normalizeChatChannelId } from "./ids-B-sRTG6a.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-CRE2SEcy.js";
import { T as validateConfigObjectWithPlugins, X as normalizeLegacyCommandsConfig, Y as normalizeBaseCompatibilityConfigValues, Z as normalizeLegacyOpenAICodexModelsAddMetadata, at as applyLegacyDoctorMigrations, k as migrateLegacySecretRefEnvMarkers, ot as applyChannelDoctorCompatibilityMigrations, z as findLegacyConfigIssues } from "./io-B4W7YRox.js";
import { n as formatConfigIssueLines } from "./issue-format-DPCYJ_FB.js";
import { s as runPluginSetupConfigMigrations } from "./setup-registry-CMHsMQMP.js";
import { i as listRouteBindings } from "./bindings-CR3ZsOC9.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-Dy4t3flq.js";
import { t as note } from "./note-DRReSDjk.js";
import { a as stripUnknownConfigKeys, r as noteOpencodeProviderOverrides } from "./doctor-config-analysis-zKZPXPy2.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-pA8kk22O.js";
import { t as applyDoctorConfigMutation } from "./config-mutation-state-DI6FwXTr.js";
import { t as asObjectRecord } from "./object-DvU6zt0b.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const pluginLegacyIssues = await (async () => {
		...
		const { collectRelevantDoctorPluginIds, listPluginDoctorLegacyConfigRules } = await import("./doctor-contract-registry-Cfe0GR6t.js");
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-DbYKFS-1.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-Dfgvqh45.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-CVFwAUNe.js");
		...
		const { collectDoctorPreviewWarnings } = await import("./preview-warnings-osBXlyxe.js");
		emitDoctorNotes({
			note,
