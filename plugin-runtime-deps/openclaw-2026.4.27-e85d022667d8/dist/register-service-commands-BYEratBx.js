...
function loadDaemonInstallModule() {
	daemonInstallModulePromise ??= import("./install.runtime-vBiptvj2.js");
	return daemonInstallModulePromise;
}
function loadDaemonLifecycleModule() {
	daemonLifecycleModulePromise ??= import("./lifecycle.runtime-lLKBxjJx.js");
	return daemonLifecycleModulePromise;
}
function loadDaemonStatusModule() {
	daemonStatusModulePromise ??= import("./status.runtime-BislEg5B.js");
