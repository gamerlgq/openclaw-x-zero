...
import { n as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-BX_oC9YK.js";
...
import { f as isLocalBaseUrl } from "./shared-YnyPjxBf.js";
import { t as toModelRow } from "./list.model-row-DLGaEAZc.js";
...
function loadModelCatalogModule() {
	modelCatalogModulePromise ??= import("./model-catalog-BfBjZIMO.js");
	return modelCatalogModulePromise;
}
function loadModelResolverModule() {
	modelResolverModulePromise ??= import("./model-BazrdoGc.js");
	return modelResolverModulePromise;
}
function loadProfileListModule() {
	profileListModulePromise ??= import("./profile-list-D-uZ4xEy.js");
	return profileListModulePromise;
}
function loadProviderCatalogModule() {
	providerCatalogModulePromise ??= import("./list.provider-catalog-BrztvDP-.js");
	return providerCatalogModulePromise;
}
function loadSyntheticAuthModule() {
	syntheticAuthModulePromise ??= import("./synthetic-auth.runtime-DvMM_HCu.js");
