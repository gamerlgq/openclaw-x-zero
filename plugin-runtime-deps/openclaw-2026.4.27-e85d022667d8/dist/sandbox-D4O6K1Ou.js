...
import { f as isSameSsrFPolicy } from "./ssrf-Wmwvy157.js";
import { c as DEFAULT_USER_FILENAME, i as DEFAULT_IDENTITY_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-ClacWI75.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, y as SANDBOX_BROWSER_SECURITY_HASH_EPOCH } from "./constants-BBwPtn03.js";
import { n as isToolAllowed } from "./tool-policy-C8nB2n1m.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-BPkEMfMR.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CJKGv-Op.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-Cj6n8_FZ.js";
import { a as DEFAULT_OPENCLAW_BROWSER_COLOR, d as ensureBrowserControlAuth, f as resolveBrowserControlAuth, l as resolveBrowserConfig, n as DEFAULT_BROWSER_ACTION_TIMEOUT_MS, s as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, u as resolveProfile } from "./browser-profiles-C2zCpnJW.js";
import { C as updateRegistry, S as updateBrowserRegistry, _ as slugifySessionKey, a as execDocker, b as removeBrowserRegistryEntry, c as readDockerContainerLabel, d as readDockerPort, g as resolveSandboxWorkspaceDir, h as resolveSandboxScopeKey, l as readDockerNetworkDriver, m as resolveSandboxAgentId, n as dockerContainerState, p as appendWorkspaceMountArgs, s as readDockerContainerEnvVar, t as buildSandboxCreateArgs, u as readDockerNetworkGateway, v as readBrowserRegistry, w as computeSandboxBrowserConfigHash, x as removeRegistryEntry, y as readRegistry } from "./docker-DYi7mRu6.js";
import { a as splitSandboxBindSpec, i as resolveSandboxHostPathViaExistingAncestor, n as validateNetworkMode } from "./validate-sandbox-security-7zsrSNwO.js";
import { C as buildPinnedMkdirpPlan, D as dockerSandboxBackendManager, E as buildPinnedWritePlan, O as runDockerSandboxShellCommand, T as buildPinnedRenamePlan, a as getSandboxBackendManager, n as startBrowserBridgeServer, r as stopBrowserBridgeServer, s as requireSandboxBackendFactory, t as BROWSER_BRIDGES, v as isPathInsideContainerRoot, w as buildPinnedRemovePlan, y as normalizeContainerPath } from "./browser-bridges-DhbcISK0.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ getRemoteSkillEligibility }, { canExecRequestNode }, { syncSkillsToWorkspace }] = await Promise.all([
				import("./skills-remote-B6m1BNDH.js"),
				import("./exec-defaults-C202htRC.js"),
				import("./skills-CgZguYzs.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune-D9HrxytS.js")).maybePruneSandboxes(cfg);
