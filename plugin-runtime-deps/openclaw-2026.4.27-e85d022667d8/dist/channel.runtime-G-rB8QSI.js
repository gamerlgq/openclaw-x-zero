...
import "./accounts-D1k84yaz.js";
import "./runtime-api-KBtZE8WV.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CHA_ps_A.js";
import { t as sendMessageZalo } from "./send-DMq214Ni.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-DDbNwTjn.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-NGNikKwg.js");
