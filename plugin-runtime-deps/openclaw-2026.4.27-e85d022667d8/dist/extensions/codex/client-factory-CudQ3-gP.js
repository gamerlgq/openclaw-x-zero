...
const defaultCodexAppServerClientFactory = (startOptions, authProfileId) => import("./shared-client-DJoT4Oru.js").then((n) => n.r).then(({ getSharedCodexAppServerClient }) => getSharedCodexAppServerClient({
	startOptions,
	authProfileId
}));
