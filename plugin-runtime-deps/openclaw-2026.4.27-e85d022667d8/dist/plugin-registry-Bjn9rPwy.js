...
import { i as normalizePluginsConfigWithResolver } from "./config-normalization-shared-CJLdU1H-.js";
...
function resolveDerivedSnapshotCacheKey(params, env) {
	if (params.cache === false || params.preferPersisted === false || params.pluginIndexFilePath || params.installRecords || params.candidates || params.diagnostics || params.now) return null;
