...
import { a as logWarn, r as logInfo } from "./logger-DzNKIQlP.js";
import { a as isSubagentSessionKey, i as isCronSessionKey, o as parseAgentSessionKey } from "./session-key-utils-B9qLc2A8.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-C6F-NnIG.js";
import { i as resolveShellEnvFallbackTimeoutMs, n as getShellPathFromLoginShell } from "./shell-env-Dv6Cj1cU.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-DetSLGQ0.js";
import { t as killProcessTree } from "./kill-tree-CDp3CFPD.js";
import { c as isGatewayMessageChannel, u as normalizeMessageChannel } from "./message-channel-BWqMq4di.js";
import { i as normalizeDeliveryContext } from "./delivery-context.shared-CHOC_AP4.js";
import { f as formatExecDeniedUserMessage, m as parseExecApprovalResultText, p as isExecDeniedResultText, u as sanitizeUserFacingText } from "./sanitize-user-facing-text-Db4qNw-M.js";
import { t as formatDurationCompact } from "./format-duration-CVZxljKj.js";
import { n as getDiagnosticSessionState } from "./diagnostic-session-state-DC-5fSCi.js";
import { b as EXEC_TOOL_DISPLAY_SUMMARY, x as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-policy-CD6MU3lK.js";
import { o as failedTextResult, v as textResult } from "./common-WwJcpwdP.js";
import { t as callGatewayTool } from "./gateway-k_GwnaUv.js";
import { t as splitShellArgs } from "./shell-argv-C9NFzxGp.js";
import { c as describeInterpreterInlineEval, f as analyzeShellCommand, l as detectInterpreterInlineEvalArgv, n as evaluateShellAllowlist, p as buildEnforcedShellCommand } from "./exec-approvals-allowlist-BYLh3KqG.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-5DS2qWOn.js";
import { C as requiresExecApproval, D as resolveExecApprovalsFromFile, E as resolveExecApprovals, _ as normalizeExecTarget, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, f as minSecurity, g as normalizeExecSecurity, l as loadExecApprovals, m as normalizeExecAsk, s as hasDurableExecApproval, u as maxAsk, v as persistAllowAlwaysPatterns, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-CvfDEUzk.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-DHlp2UHm.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-Bq-UB8tM.js";
import "./delivery-context-hNWv_DOh.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DylRPCNG.js";
import { t as sendMessage } from "./message-Dx0SI10A.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-BzGML9NV.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-DdS8T1lK.js";
import { f as resolveExecApprovalInitiatingSurfaceState, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-DaGHEmwS.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-CoF_tLHM.js";
import { t as getProcessSupervisor } from "./supervisor-BEdxWHRX.js";
import { C as markExited, S as markBackgrounded, T as tail, _ as drainSession, a as DEFAULT_PENDING_MAX_OUTPUT, b as listFinishedSessions, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, g as deleteSession, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput, v as getFinishedSession, w as setJobTtlMs, x as listRunningSessions, y as getSession } from "./bash-tools.exec-runtime-CyhucR37.js";
import { n as resolveSystemRunCommandRequest, t as formatExecCommand } from "./system-run-command-EObQMKkG.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-CrxPhAlh.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-w9Eg1NiN.js";
...
async function loadFsSafeModule() {
	fsSafeModulePromise ??= import("./fs-safe-tcoSU0im.js");
