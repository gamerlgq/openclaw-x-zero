...
import { i as isDiagnosticsEnabled, l as createChildDiagnosticTraceContext, p as freezeDiagnosticTraceContext, r as emitTrustedDiagnosticEvent } from "./diagnostic-events-BwpOTDQH.js";
import { r as logVerbose } from "./globals-8N5C2Ov_.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-C6F-NnIG.js";
import { p as resolveSessionAgentId, t as hasConfiguredModelFallbacks } from "./agent-scope-RNt6KatQ.js";
import { i as getRuntimeConfig, it as resolveCliRuntimeExecutionProvider, tt as isCliRuntimeAlias } from "./io-B4W7YRox.js";
import "./defaults-WmkV2Z8L.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-CxqiRMUZ.js";
import "./config-CopVFMnG.js";
import { f as resolveMessageChannel, i as isMarkdownCapableMessageChannel, r as isInternalMessageChannel } from "./message-channel-BWqMq4di.js";
import { _ as resolveMemoryFlushPlan } from "./memory-state-MIj6In9p.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-Buswj6xX.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-Bg_QeV2r.js";
import { t as loadSessionStore } from "./store-load-Ctb7CJ9w.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-ahx75vGe.js";
import { g as resolveGroupSessionKey, o as updateSessionStore, s as updateSessionStoreEntry } from "./store-BNAn-6FU.js";
import "./sessions-D8ANGXQF.js";
import { _ as resolveModelRefFromString } from "./model-selection-shared-BAGl40FK.js";
import { h as resolveResponseUsageMode, m as normalizeVerboseLevel } from "./thinking-CazsQW32.js";
import { t as isCliProvider } from "./model-selection-cli-Bnb0eHeZ.js";
import "./model-selection-DGI1ibK2.js";
import { i as enqueueSystemEvent } from "./system-events-CAt6m2Yr.js";
import { i as formatRateLimitOrOverloadedErrorCopy, t as BILLING_ERROR_USER_MESSAGE, u as sanitizeUserFacingText, v as formatRawAssistantErrorForUi } from "./sanitize-user-facing-text-Db4qNw-M.js";
import { i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-T6LUQcna.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-BIJuzXU-.js";
import { _ as createReplyOperation, c as queueEmbeddedPiMessage, g as ReplyRunAlreadyActiveError, v as replyRunRegistry } from "./runs-5aKKRCJv.js";
import { o as isAudioFileName } from "./mime-srMFIJPy.js";
import { a as resolveContextTokensForModel } from "./context-CkDnulDn.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-CMWmFq2m.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "./usage-DHoo33i9.js";
import { i as readSessionMessages } from "./session-utils.fs-bNM54VNU.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-C3Ae4W02.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-CcuIP5Dq.js";
import { c as stripHeartbeatToken } from "./heartbeat-CxHCYc7v.js";
import { A as readPostCompactionContext } from "./compaction-successor-transcript-BwDunTlM.js";
import { c as isLikelyExecutionAckPrompt } from "./selection-8xKkwZC_.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-Cr2k_1LL.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-BPCoyZ31.js";
import { i as resolveSandboxConfigForAgent } from "./config-BPkEMfMR.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CJKGv-Op.js";
import { _ as isTransientHttpError, d as isContextOverflowError, m as isLikelyContextOverflowError, u as isCompactionFailureError } from "./errors-CoQ9mM7g.js";
import "./pi-embedded-helpers-f4IO3CdD.js";
import { c as resolveModelAuthMode } from "./model-auth-CsyLGY9m.js";
import { n as setReplyPayloadMetadata, t as getReplyPayloadMetadata } from "./reply-payload-N4uBXXeQ.js";
import { u as parseReplyDirectives } from "./payloads-DvS9-Jrq.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-f5NvMXJ4.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback, t as isFallbackSummaryError } from "./model-fallback-BnlDCIrS.js";
import { a as generateSecureUuid } from "./secure-random-D3NKm3ta.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-Bf0SE_9l.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-CoJVVh0h.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-B0Rs1iB2.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-BM0cEgcN.js";
import { o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession } from "./queue-CY5zhAjC.js";
import "./sandbox-D4O6K1Ou.js";
import { i as estimateMessagesTokens } from "./compaction-Dgl_FCSL.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-CLyF5vpj.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-hcIw8Hlz.js";
import { r as resolveCronStorePath, t as loadCronStore } from "./store-DKoc1lYY.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-bmRHXe4n.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-kC2wpVNF.js";
import { r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-BPLl8j5u.js";
import { c as setCliSessionId, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-B6rq5LPQ.js";
import { t as runCliAgent } from "./cli-runner-Bqcjf0_-.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-ioGNNrFZ.js";
import { t as formatProviderModelRef } from "./model-runtime-DATWIRIw.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-CMTmKS6-.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-D55Eb7ex.js";
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded-Bu4u3w6A.js");
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-BEjapR72.js");
