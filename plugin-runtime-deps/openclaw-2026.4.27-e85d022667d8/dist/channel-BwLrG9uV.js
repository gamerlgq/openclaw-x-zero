...
import { h as MarkdownConfigSchema, l as GroupPolicySchema, o as DmPolicySchema } from "./zod-schema.core-urFIFYTN.js";
import { n as buildCatchallMultiAccountChannelSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-DGNvFT8C.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-CRE2SEcy.js";
import { i as createLazyRuntimeNamedExport, r as createLazyRuntimeModule } from "./lazy-runtime-y64shOif.js";
import { b as sendPayloadWithChunkedTextAndMedia, l as isNumericTargetId } from "./reply-payload-f5NvMXJ4.js";
import { g as readStringParam, l as jsonResult } from "./common-WwJcpwdP.js";
import { l as createScopedDmSecurityResolver, m as mapAllowFromEntries, s as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-PDuqRwGa.js";
import "./text-runtime-BfJujyVf.js";
import { r as describeWebhookAccountSnapshot } from "./account-helpers-DrLhTqe3.js";
import { n as createStaticReplyToModeResolver } from "./threading-helpers-Bk_hN-Qw.js";
import { d as stripTargetKindPrefix, i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-CFps7yDe.js";
...
import { S as createOpenProviderGroupPolicyWarningCollector, o as buildOpenGroupPolicyRestrictSendersWarning, s as buildOpenGroupPolicyWarning } from "./channel-policy-C8rNV1ba.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-D5HxdrCx.js";
import { p as listResolvedDirectoryUserEntriesFromAllowFrom } from "./directory-config-helpers-DynPMJ9l.js";
import { d as createDefaultChannelRuntimeState, o as buildTokenChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-CSU570uL.js";
import { t as extractToolSend } from "./tool-send-Df120P97.js";
...
import { a as coerceStatusIssueAccountId, d as readStatusIssueFields } from "./extension-shared-DKccoh8F.js";
import "./channel-actions-BiRZGQ_Z.js";
import { a as createEmptyChannelResult, o as createRawChannelSendResultAdapter } from "./channel-send-result-DZHlRTeE.js";
import "./channel-status-CQ0AIASE.js";
import { t as zod_exports } from "./zod-C2RJs7Tu.js";
import { i as resolveZaloAccount, n as listZaloAccountIds, r as resolveDefaultZaloAccountId, t as listEnabledZaloAccounts } from "./accounts-D1k84yaz.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-BFm_KleQ.js";
import { r as zaloSetupAdapter, t as createZaloSetupWizardProxy } from "./setup-core-PkowsWM2.js";
//#region extensions/zalo/src/actions.ts
const loadZaloActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-Dj6b7ZXb.js"), "zaloActionsRuntime");
...
const loadZaloChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-G-rB8QSI.js"));
const zaloSetupWizard = createZaloSetupWizardProxy(async () => (await import("./setup-surface-DGlJ0wE-.js")).zaloSetupWizard);
