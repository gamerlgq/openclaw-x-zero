...
import { n as isAbortError } from "./unhandled-rejections-CzVfidKB.js";
import { n as findNormalizedProviderValue } from "./provider-id-DMUF3fJY.js";
import { a as shouldLogVerbose, r as logVerbose } from "./globals-8N5C2Ov_.js";
...
import { n as normalizeMediaProviderId } from "./config-provider-models-BLe4SK7D.js";
import { h as getMediaUnderstandingProvider, m as buildMediaUnderstandingRegistry, p as providerSupportsCapability } from "./defaults-Dmvw73MC.js";
import { i as resolveModelEntries, o as resolveScopeDecision } from "./resolve-BpqbIJ9X.js";
import { r as fetchWithTimeout } from "./fetch-timeout-CkiSffW0.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-srMFIJPy.js";
import { a as safeFileURLToPath, t as assertNoWindowsNetworkPath } from "./local-file-access-pjYL9RYy.js";
import { n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-BgxNacCx.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-D9P5aesv.js";
import { t as buildRandomTempFilePath } from "./temp-download-DfXVZHIu.js";
import { _ as fileExists, a as runCliEntry, g as extractGeminiResponse, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaUnderstandingSkipError, y as isMediaUnderstandingSkipError } from "./runner.entries-DyxW_lcz.js";
import "./shared-CkW2NAVy.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-3bwc1b5a.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-BfBjZIMO.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-k91RFio8.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-D6igaejv.js");
