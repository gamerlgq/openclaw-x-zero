...
import { n as isVitestRuntimeEnv } from "./env-BvnVJRcO.js";
import { n as defaultRuntime } from "./runtime-CIJX7ulQ.js";
import { i as getChildLogger } from "./logger-B7txuiSU.js";
import { t as createSubsystemLogger } from "./subsystem-Izr-DYZz.js";
import { r as isCronRunSessionKey } from "./session-key-utils-B9qLc2A8.js";
import { c as normalizeAgentId, h as toAgentStoreSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-C6F-NnIG.js";
import { S as resolveDefaultAgentId } from "./agent-scope-RNt6KatQ.js";
import { i as getRuntimeConfig } from "./io-B4W7YRox.js";
import { n as resolveSubagentMaxConcurrent, t as resolveAgentMaxConcurrent } from "./agent-limits-CO4RFHlv.js";
import { t as parseDurationMs } from "./parse-duration-sSTfcZq4.js";
import { i as resolveMainSessionKey, n as resolveAgentMainSessionKey, t as canonicalizeMainSessionAlias } from "./main-session-BL2mQdLD.js";
import { u as resolveStorePath } from "./paths-Bg_QeV2r.js";
import { t as loadSessionStore } from "./store-load-Ctb7CJ9w.js";
import { o as updateSessionStore, t as archiveRemovedSessionTranscripts } from "./store-BNAn-6FU.js";
import "./sessions-D8ANGXQF.js";
import "./logging-PpNMlTsX.js";
import { n as requestHeartbeatNow } from "./heartbeat-wake-CcEPPt63.js";
import { i as enqueueSystemEvent } from "./system-events-CAt6m2Yr.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId } from "./detached-task-runtime-CSPIY7Xg.js";
import { t as SsrFBlockedError } from "./ssrf-Wmwvy157.js";
...
import { i as cleanupArchivedSessionTranscripts } from "./session-transcript-files.fs-C3Ae4W02.js";
import { a as enqueueCommandInLane, f as setCommandLaneConcurrency } from "./command-queue-CcuIP5Dq.js";
import { o as resolveFailoverReasonFromError } from "./failover-error-9zkewhNf.js";
import { a as resolveCronNotificationSessionKey, i as resolveCronDeliverySessionKey, o as resolveCronSessionTargetSessionKey, r as isInvalidCronSessionTargetIdError, t as normalizeHttpWebhookUrl } from "./webhook-url-BWgHrlyB.js";
import { n as normalizeCronJobInput } from "./normalize-BLeqh6NH.js";
...
import { a as cronSchedulingInputsEqual, i as saveCronStore, r as resolveCronStorePath, t as loadCronStore } from "./store-DKoc1lYY.js";
import { n as resolveAgentOutboundIdentity } from "./identity-C3EJs1HN.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-CK-dEwIc.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-C2Oo2ffe.js";
import { _ as markCronJobActive, g as clearCronJobActive } from "./task-registry.maintenance-CoV5dkSd.js";
import { a as resolveCronRunLogPath, o as resolveCronRunLogPruneOptions, t as appendCronRunLog } from "./run-log-BHR3om4s.js";
import { n as resolveFailureDestination, t as resolveCronDeliveryPlan } from "./delivery-plan-BV3dey5i.js";
import { t as runCronIsolatedAgentTurn } from "./isolated-agent-2EJk8LK0.js";
import { _ as resolveDeliveryTarget, a as computeJobPreviousRunAtMs, c as findJobOrThrow, d as isJobEnabled, f as nextWakeAtMs, g as resolveJobPayloadTextForMain, h as recordScheduleComputeError, i as computeJobNextRunAtMs, l as hasScheduledNextRunAtMs, m as recomputeNextRunsForMaintenance, n as applyJobPatch, o as createJob, p as recomputeNextRuns, r as assertSupportedJobSpec, s as errorBackoffMs, t as DEFAULT_ERROR_BACKOFF_SCHEDULE_MS, u as isJobDue } from "./jobs-D4WzIr_q.js";
import { t as createCronExecutionId } from "./run-id-BmZg5F55.js";
import { n as resolveGatewayReloadSettings } from "./config-reload-B8Hbe_dn.js";
import { n as runHeartbeatOnce, r as startHeartbeatRunner } from "./heartbeat-runner-Dd4J0PXH.js";
...
function recoverPendingOutboundDeliveries(params) {
	(async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-Cyyg33vX.js");
		const { deliverOutboundPayloads } = await import("./deliver-B3lVxtuf.js");
...
function recoverPendingSessionDeliveries(params) {
	setTimeout(() => {
		(async () => {
			const { recoverPendingRestartContinuationDeliveries } = await import("./server-restart-sentinel-CrdAyt4a.js");
...
function startGatewayModelPricingRefreshOnDemand(params) {
	...
	let stopRefresh;
	(async () => {
		const { startGatewayModelPricingRefresh } = await import("./model-pricing-cache-CbDyDGbo.js");
		if (stopped) return;
