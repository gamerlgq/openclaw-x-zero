...
import { Br as ErrorCodes, Vr as errorShape } from "./protocol-BvHKcb_2.js";
import { i as wrapExternalContent } from "./external-content-1qA06ZEJ.js";
import { c as imageResultFromFile, g as readStringParam, l as jsonResult } from "./common-WwJcpwdP.js";
import { t as callGatewayTool } from "./gateway-k_GwnaUv.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-DylRPCNG.js";
import "./text-runtime-BfJujyVf.js";
import { n as startLazyPluginServiceModule } from "./plugin-runtime-BwqQVVpD.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-DQCRGepm.js";
import { t as safeParseJson } from "./server-json-CLBM-p_d.js";
import { n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-BOn4w5OI.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-BKgfKpUc.js";
import { t as withTimeout } from "./sdk-node-runtime-DAI4fpXM.js";
import "./sdk-security-runtime-CxoaddUV.js";
import { D as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-DMQRJz_c.js";
import "./control-auth-D31ecs_n.js";
import { c as resolveExistingPathsWithinRoot, i as resolveProfile, n as resolveBrowserConfig, s as DEFAULT_UPLOAD_DIR } from "./config-CwWAxEru.js";
import "./sdk-setup-tools-Dnu3DN5M.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-DJYLj0HS.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-D-iKh-nf.js";
import { r as getBrowserProfileCapabilities } from "./target-id-DUBrD4wU.js";
import { a as createBrowserRouteDispatcher, r as startBrowserControlServiceFromConfig, t as createBrowserControlContext } from "./control-service-YXP-4nk6.js";
import "./core-api-BHlR0WWd.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-Cl-5cBFY.js"),
