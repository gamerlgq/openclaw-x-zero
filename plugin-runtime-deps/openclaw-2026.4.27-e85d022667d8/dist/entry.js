...
import { a as parseCliContainerArgs, n as applyCliProfileEnv, o as resolveCliContainerTarget, r as parseCliProfileArgs, t as normalizeWindowsArgv } from "./windows-argv-rls3G_6B.js";
import { t as resolveNodeStartupTlsEnvironment } from "./node-startup-env-Cg_zR9VI.js";
import { i as normalizeEnv, t as isTruthyEnvValue } from "./env-BvnVJRcO.js";
...
function tryHandleRootVersionFastPath(argv, deps = {}) {
	...
	(deps.resolveVersion ?? (async () => {
		const [{ VERSION }, { resolveCommitHash }] = await Promise.all([import("./version-CFYXGG_n.js"), import("./git-commit-CRicIFme.js")]);
		return {
			VERSION,
			resolveCommitHash
		};
...
async function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	try {
		...
		if (!(deps.outputPrecomputedRootHelpText ?? (await import("./root-help-metadata-L9y2RJsz.js")).outputPrecomputedRootHelpText)()) {
			const { outputRootHelp } = await import("./root-help-X_sUYrsl.js");
