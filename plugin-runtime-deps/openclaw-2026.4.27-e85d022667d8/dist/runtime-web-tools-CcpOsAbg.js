...
import { u as secretRefKey } from "./ref-contract-DtvCiPbj.js";
import { l as resolveEnableState, o as normalizePluginsConfig } from "./config-state-cB4SZz9a.js";
import { l as loadBundledChannelSecretContractApi } from "./target-registry-DOBQeKjE.js";
import "./shared-C9ga15VD.js";
import { i as loadInstalledPluginIndexInstallRecordsSync } from "./manifest-registry-adU8lVLL.js";
import { o as resolveSecretRefValues } from "./resolve-CKxwAAOr.js";
import { S as resolveDefaultAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-RNt6KatQ.js";
import { n as getBootstrapChannelSecrets } from "./bootstrap-registry-CSEgA6OB.js";
import "./installed-plugin-index-records-D8w5X7uR.js";
import { n as resolvePluginConfigContractsById, t as collectPluginConfigContractMatches } from "./config-contracts-BlvCFExB.js";
...
import { a as createLazyRuntimeSurface, i as createLazyRuntimeNamedExport } from "./lazy-runtime-y64shOif.js";
import { n as resolveConfiguredMediaEntryCapabilities, r as resolveEffectiveMediaEntryCapabilities } from "./entry-capabilities-DBn1ATuI.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts, r as resolveBundledExplicitWebFetchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-DVl2HWOD.js";
import { c as pushInactiveSurfaceWarning, l as pushWarning, n as collectSecretInputAssignment } from "./runtime-shared-ClUz2kEK.js";
import { t as collectTtsApiKeyAssignments } from "./runtime-config-collectors-tts-CDSAn1jv.js";
import { n as evaluateGatewayAuthSurfaceStates } from "./runtime-gateway-auth-surfaces-7OlMAWXn.js";
import { o as sortWebFetchProvidersForAutoDetect, r as sortWebSearchProvidersForAutoDetect } from "./web-search-providers.shared-Dapa4fBD.js";
...
const loadResolveManifestContractOwnerPluginId = createLazyRuntimeNamedExport(() => import("./runtime-web-tools-manifest.runtime-Br80xM65.js"), "resolveManifestContractOwnerPluginId");
...
const loadRuntimeWebToolsFallbackProviders = createLazyRuntimeSurface(() => import("./runtime-web-tools-fallback.runtime-DxOWQ5JQ.js"), ({ runtimeWebToolsFallbackProviders }) => runtimeWebToolsFallbackProviders);
const loadRuntimeWebToolsPublicArtifacts = createLazyRuntimeSurface(() => import("./runtime-web-tools-public-artifacts.runtime-CJeQkv1c.js"), (mod) => mod);
const loadRuntimeWebToolsManifest = createLazyRuntimeSurface(() => import("./runtime-web-tools-manifest.runtime-Br80xM65.js"), (mod) => mod);
