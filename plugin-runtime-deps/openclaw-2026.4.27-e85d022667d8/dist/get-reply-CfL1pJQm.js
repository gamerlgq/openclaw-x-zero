...
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-BgTtzLL7.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-B-sRTG6a.js";
import { n as defaultRuntime } from "./runtime-CIJX7ulQ.js";
import { r as logVerbose } from "./globals-8N5C2Ov_.js";
import { t as createSubsystemLogger } from "./subsystem-Izr-DYZz.js";
import { a as isSubagentSessionKey, n as isAcpSessionKey, o as parseAgentSessionKey } from "./session-key-utils-B9qLc2A8.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey } from "./session-key-C6F-NnIG.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-CrWuRmeo.js";
import { b as resolveAgentDir, g as listAgentEntries, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, v as resolveAgentConfig, x as resolveAgentWorkspaceDir } from "./agent-scope-RNt6KatQ.js";
import { i as getRuntimeConfig } from "./io-B4W7YRox.js";
import { a as normalizeAnyChannelId } from "./registry-C85w3UMa.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-j3Okv59Q.js";
import { a as normalizeChannelId, i as listChannelPlugins, t as getChannelPlugin } from "./registry-dXGKA3mU.js";
import "./defaults-WmkV2Z8L.js";
import "./config-CopVFMnG.js";
import "./message-channel-core-CBEs3UOo.js";
import { d as resolveGatewayMessageChannel, r as isInternalMessageChannel, s as isDeliverableMessageChannel, u as normalizeMessageChannel } from "./message-channel-BWqMq4di.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-Dj8S9UNT.js";
import { h as resetRegisteredAgentHarnessSessions } from "./loader-CPsG_3Jg.js";
import { l as fireAndForgetHook, t as getGlobalHookRunner } from "./hook-runner-global-BmRBtwY4.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-DzUdlZ65.js";
import { g as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-DH5Ph4Z1.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-BL2mQdLD.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-Bg_QeV2r.js";
import { a as normalizeSessionDeliveryFields, i as normalizeDeliveryContext, n as deliveryContextKey, t as deliveryContextFromSession } from "./delivery-context.shared-CHOC_AP4.js";
import { s as resolveMaintenanceConfigFromInput, t as loadSessionStore } from "./store-load-Ctb7CJ9w.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-ahx75vGe.js";
import { f as deriveSessionMetaPatch, g as resolveGroupSessionKey, l as resolveSessionStoreEntry, o as updateSessionStore } from "./store-BNAn-6FU.js";
import { t as normalizeChatType } from "./chat-type-DuQW6e8F.js";
import "./plugins-Bc9yusIY.js";
import { r as resolveSessionLifecycleTimestamps } from "./sessions-D8ANGXQF.js";
import { c as resolveSessionResetPolicy, i as resolveThreadFlag, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-u2ZBdjVJ.js";
import { n as resolveSessionKey } from "./session-key-DF9YTbGq.js";
import { c as resolveAndPersistSessionFile, s as parseSessionThreadInfoFast } from "./transcript-D-_7jiGc.js";
import { _ as resolveModelRefFromString } from "./model-selection-shared-BAGl40FK.js";
import { d as normalizeThinkLevel, m as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, t as formatThinkingLevels } from "./thinking-CazsQW32.js";
...
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-BIJuzXU-.js";
import { c as retireSessionMcpRuntime } from "./pi-bundle-mcp-runtime-BZXzXJCi.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-CD6MU3lK.js";
import "./pi-bundle-mcp-tools-DcJhmfN5.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-1V1aESqo.js";
import { t as finalizeInboundContext } from "./inbound-context-BPrXNWmC.js";
import { r as clearCommandLane, s as getQueueSize } from "./command-queue-CcuIP5Dq.js";
import { r as HEARTBEAT_TRANSCRIPT_PROMPT } from "./heartbeat-CxHCYc7v.js";
import { t as isReasoningTagProvider } from "./provider-utils-pRuyqCiK.js";
import { l as ensureAgentWorkspace } from "./workspace-ClacWI75.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-CbznYzHZ.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-CJKGv-Op.js";
import { t as collectTextContentBlocks } from "./content-blocks-CDg3qB3X.js";
import "./delivery-context-hNWv_DOh.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-DCNBcCMd.js";
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-N1YEXX3q.js";
import { i as generateSecureToken } from "./secure-random-D3NKm3ta.js";
import { n as resolveSilentReplySettings } from "./silent-reply-CuB457HX.js";
import { t as buildOutboundSessionContext } from "./session-context-BqFAea4R.js";
import { t as resolveQueueSettings } from "./queue-CY5zhAjC.js";
import { r as getSessionBindingService } from "./session-binding-service-DZ5PKgpI.js";
import { r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-Bp5EN93I.js";
import { a as resolveParentForkMaxTokens, i as forkSessionFromParent, o as resolveParentForkTokenCount } from "./subagent-spawn-Xu_D1lw0.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-wQ1tFjU4.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-C2JSFcle.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-HNJRPq7d.js";
import { t as hasControlCommand } from "./command-detection-RxNwxlBu.js";
import "./commands-registry-BQ3mD9-3.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-B0aA1PaV.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-GWK9R7Wa.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-DEuCG3JW.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy } from "./typing-policy-dPDddF9n.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-grRVAhSU.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-YoGOsqNr.js";
import { t as resolveChannelModelOverride } from "./model-overrides-ybW_kELi.js";
import { t as normalizeGroupActivation } from "./group-activation-DN4D_496.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-DaaSyzW3.js";
import { t as resolveFastModeState } from "./fast-mode-lyul6D_G.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-bmRHXe4n.js";
import { t as buildCommandContext } from "./commands-context-DPiXL49H.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-BZQNRIzw.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-CWf9WnLw.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-DmDqDZ59.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-CLL3YoOe.js";
import { t as resolveStoredModelOverride } from "./stored-model-override-ChBMSpda.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-CQswGN9q.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-Dq1nCvPf.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-D7brkqsE.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-Cz_thvPL.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-Us6OiZ5f.js";
import { t as hasInboundMedia } from "./inbound-media-BKhLPB1R.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-kC2wpVNF.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-BPLl8j5u.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-PhOkdD8r.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-DhmwotcA.js";
import { r as getCliSessionBinding } from "./cli-session-B6rq5LPQ.js";
import { n as resolveResetPreservedSelection, t as clearSessionResetRuntimeState } from "./session-reset-cleanup-fQgzFOjO.js";
import { t as closeTrackedBrowserTabsForSessions } from "./browser-maintenance-D9jiTqfa.js";
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-D0PlXVOp.js";
import { t as isResetAuthorizedForContext } from "./reset-authorization-Be4iyQcx.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks-C3M1F3hx.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-DZ4vPJZR.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-XEJCpRk8.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-XHZNQJ1v.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-DuppPpb5.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-C08aZfeJ.js");
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-mkB8Drtx.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-C8yTTH7m.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-B7Mol65D.js");
...
function loadSkillCommandsRuntime() {
	skillCommandsRuntimePromise ??= import("./skill-commands.runtime-B7Mol65D.js");
	return skillCommandsRuntimePromise;
}
function loadOpenClawToolsRuntime() {
	openClawToolsRuntimePromise ??= import("./openclaw-tools.runtime-CdeWO272.js");
	return openClawToolsRuntimePromise;
}
function loadAbortCutoffRuntime() {
	abortCutoffRuntimePromise ??= import("./abort-cutoff.runtime-DoJ1zORT.js");
	return abortCutoffRuntimePromise;
}
function loadCommandsRuntime() {
	commandsRuntimePromise ??= import("./commands.runtime-Bm7T3U4t.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-Coj2cLu0.js");
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-sYVnqJ6F.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-Oc8_dZn0.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-j8oOO0aU.js");
	return sessionUpdatesRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./store.runtime-Coj2cLu0.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-C_tb2qql.js");
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-C2Mpf4JB.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-BJrKwPrk.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-3sAwFp-k.js");
...
function loadCommandsCoreRuntime() {
	commandsCoreRuntimePromise ??= import("./commands-core.runtime-C8008QwH.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-BwtzgM2z.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-Bj5B3OTP.js");
