...
import { n as defaultSlotIdForKey } from "./slots-tjp1BFoh.js";
import { i as runExec } from "./exec-2P596n4G.js";
import { r as normalizeControlUiBasePath } from "./control-ui-shared-Bd4kEXvf.js";
import { s as hasConfiguredChannelsForReadOnlyScope } from "./gateway-startup-plugin-ids-BthrJK4f.js";
import { t as createEmptyTaskRegistrySummary } from "./task-registry.summary-CETuqQCm.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-6534Mgqp.js";
import { t as resolveOsSummary } from "./os-summary-CdeaKCMJ.js";
import "./channel-plugin-ids-Bwb66ujx.js";
import { n as createEmptyTaskAuditSummary } from "./task-registry.audit.shared-D-0kclKE.js";
import { t as pickGatewaySelfPresence } from "./gateway-presence-COj_lM6L.js";
import { r as isProbeReachable } from "./helpers-CL0Oyc6J.js";
import { t as resolveGatewayProbeTarget } from "./probe-target-B9O9r9lY.js";
...
function loadGatewayProbeModule() {
	gatewayProbeModulePromise ??= import("./status.gateway-probe-DdM72axp.js");
	return gatewayProbeModulePromise;
}
function loadProbeGatewayModule() {
	probeGatewayModulePromise ??= import("./probe-DRn7iQIf.js");
...
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-Bvxgqagf.js");
	return statusScanDepsRuntimeModulePromise;
}
function loadStatusAgentLocalModule() {
	statusAgentLocalModulePromise ??= import("./status.agent-local-BOG_4KHg.js");
	return statusAgentLocalModulePromise;
}
function loadStatusUpdateModule() {
	statusUpdateModulePromise ??= import("./status.update-DuHZSyDH.js");
	return statusUpdateModulePromise;
}
function loadStatusScanRuntimeModule() {
	statusScanRuntimeModulePromise ??= import("./status.scan.runtime-MRy8OcNY.js");
	return statusScanRuntimeModulePromise;
}
function loadGatewayCallModule() {
	gatewayCallModulePromise ??= import("./call-Ze4iYCaI.js");
	return gatewayCallModulePromise;
}
function loadStatusSummaryModule() {
	statusSummaryModulePromise ??= import("./status.summary-IQyM_3cN.js");
...
function loadCommandConfigResolutionModule() {
	commandConfigResolutionModulePromise ??= import("./command-config-resolution-D1fqzn1Y.js");
	return commandConfigResolutionModulePromise;
}
function loadCommandSecretTargetsModule() {
	commandSecretTargetsModulePromise ??= import("./command-secret-targets-Cld2ckCB.js");
