...
import { t as listPluginContributionIds, v as loadPluginRegistrySnapshot } from "./plugin-registry-Bjn9rPwy.js";
import { o as getResolvedLoggerSettings } from "./logger-B7txuiSU.js";
import { t as danger } from "./globals-8N5C2Ov_.js";
import { n as normalizeAccountId } from "./account-id-CRE2SEcy.js";
import { S as resolveDefaultAgentId, x as resolveAgentWorkspaceDir } from "./agent-scope-RNt6KatQ.js";
import { i as getBundledChannelSetupPlugin } from "./bundled-Bd_aUa8x.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-B4W7YRox.js";
import { o as normalizeChannelId } from "./registry-C85w3UMa.js";
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-dXGKA3mU.js";
import { r as replaceConfigFile } from "./mutate-Bnr0cx3h.js";
import "./config-CopVFMnG.js";
import "./plugins-Bc9yusIY.js";
import "./logging-PpNMlTsX.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-CRWb7uup.js";
import { t as listReadOnlyChannelPluginsForConfig } from "./read-only-B4EkEtUx.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-CQsa2CXb.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-01kLfguM.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-D5_OgjA3.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-gYLJgwG8.js";
import { t as createClackPrompter } from "./clack-prompter-DI1GTX4M.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit-ByLf1e0w.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-BbY_lTSe.js";
...
import { t as parseLogLine } from "./parse-log-line-ih9NhnmC.js";
import { a as describeBinding, t as applyAgentBindings } from "./agents.bindings-Bphhk4ng.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-h0fosIZf.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-K83H4mZO.js";
import { t as channelsListCommand } from "./list-0CCydE1C.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-yoKR2-zl.js";
...
function loadChannelSetupPluginInstall() {
	channelSetupPluginInstallPromise ??= import("./plugin-install-B_-VTN8R.js");
	return channelSetupPluginInstallPromise;
}
function loadOnboardChannels() {
	onboardChannelsPromise ??= import("./onboard-channels-BDf2Wt0s.js");
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	const { listChannelPluginCatalogEntries } = await import("./catalog-DNScgzY_.js");
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-C1dDci_n.js"), loadOnboardChannels()]);
	...
	if (!channel && catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-C86rGIaN.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-N5GbV6El.js");
