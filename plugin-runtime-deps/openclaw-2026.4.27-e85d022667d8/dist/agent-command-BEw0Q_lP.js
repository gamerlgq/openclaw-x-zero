...
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-C6F-NnIG.js";
import { _ as listAgentIds, b as resolveAgentDir, l as resolveAgentSkillsFilter, p as resolveSessionAgentId, u as resolveEffectiveModelFallbacks, x as resolveAgentWorkspaceDir } from "./agent-scope-RNt6KatQ.js";
import { d as readConfigFileSnapshotForWrite, i as getRuntimeConfig } from "./io-B4W7YRox.js";
...
import { f as resolveMessageChannel } from "./message-channel-BWqMq4di.js";
import { n as ensureAuthProfileStore } from "./store-lvugMVfA.js";
import { i as emitAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-Buswj6xX.js";
import { h as stringifyRouteThreadId } from "./channel-route-Ba1iMnBc.js";
import { o as normalizeAccountId } from "./delivery-context.shared-CHOC_AP4.js";
import { b as normalizeModelRef, m as resolveConfiguredModelRef, x as parseModelRef, y as modelKey } from "./model-selection-shared-BAGl40FK.js";
...
import { o as resolveDefaultModelForAgent, p as resolveThinkingDefault, t as buildAllowedModelSet } from "./model-selection-DGI1ibK2.js";
import { n as loadModelCatalog } from "./model-catalog-BXENBv-p.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CMjJybYF.js";
import { t as AGENT_LANE_SUBAGENT } from "./lanes-D_0pSTiz.js";
import { t as createTrajectoryRuntimeRecorder } from "./runtime-BqkFwuhm.js";
import { l as ensureAgentWorkspace } from "./workspace-ClacWI75.js";
import { i as LiveSessionModelSwitchError, r as runWithModelFallback } from "./model-fallback-BnlDCIrS.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-CQsa2CXb.js";
import { t as buildOutboundSessionContext } from "./session-context-BqFAea4R.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DF_qAEIH.js";
import { n as normalizeSpawnedRunMetadata } from "./spawned-context-Bp5EN93I.js";
import { r as resolveSession } from "./live-model-switch-i6nsHe9B.js";
import { t as classifyEmbeddedPiRunResultForModelFallback } from "./result-fallback-classifier-BfQx-pcn.js";
import { n as resolveSendPolicy } from "./send-policy-Bc9geqNO.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-CLL3YoOe.js";
import { n as applyVerboseOverride } from "./level-overrides-CuleMGtJ.js";
import { i as resolveInternalEventTranscriptBody, n as prependInternalEventContext, r as resolveAcpPromptBody, t as persistSessionEntry$1 } from "./attempt-execution.shared-Y3_E_XG4.js";
...
async function resolveAgentRuntimeConfig(runtime, params) {
	...
	}) ? (await (await import("./command-config-resolution.runtime-u_mAB6kB.js")).resolveCommandConfigWithSecrets({
		config: loadedRaw,
		commandName: "agent",
...
function loadAttemptExecutionRuntime() {
	attemptExecutionRuntimePromise ??= import("./attempt-execution.runtime-CmHIb09t.js");
	return attemptExecutionRuntimePromise;
}
function loadAcpManagerRuntime() {
	acpManagerRuntimePromise ??= import("./manager-D2dK_X6w.js");
	return acpManagerRuntimePromise;
}
function loadAcpPolicyRuntime() {
	acpPolicyRuntimePromise ??= import("./policy-cGSJUAPS.js");
	return acpPolicyRuntimePromise;
}
function loadAcpRuntimeErrorsRuntime() {
	acpRuntimeErrorsRuntimePromise ??= import("./errors-DesijmHA.js");
	return acpRuntimeErrorsRuntimePromise;
}
function loadAcpSessionIdentifiersRuntime() {
	acpSessionIdentifiersRuntimePromise ??= import("./session-identifiers-Dysaw2Vz.js");
	return acpSessionIdentifiersRuntimePromise;
}
function loadDeliveryRuntime() {
	deliveryRuntimePromise ??= import("./delivery.runtime-CvkR-l5f.js");
	return deliveryRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./session-store.runtime-Cv0QB0wD.js");
	return sessionStoreRuntimePromise;
}
function loadCliCompactionRuntime() {
	cliCompactionRuntimePromise ??= import("./cli-compaction-BgHCxY0i.js");
	return cliCompactionRuntimePromise;
}
function loadTranscriptResolveRuntime() {
	transcriptResolveRuntimePromise ??= import("./transcript-resolve.runtime-CnDs2IMD.js");
	return transcriptResolveRuntimePromise;
}
function loadCliDepsRuntime() {
	cliDepsRuntimePromise ??= import("./deps-CHZsOgsY.js");
	return cliDepsRuntimePromise;
}
function loadExecDefaultsRuntime() {
	execDefaultsRuntimePromise ??= import("./exec-defaults-C202htRC.js");
	return execDefaultsRuntimePromise;
}
function loadSkillsRuntime() {
	skillsRuntimePromise ??= import("./skills-CgZguYzs.js");
	return skillsRuntimePromise;
}
function loadSkillsFilterRuntime() {
	skillsFilterRuntimePromise ??= import("./filter-DakrA0SH.js");
	return skillsFilterRuntimePromise;
}
function loadSkillsRefreshStateRuntime() {
	skillsRefreshStateRuntimePromise ??= import("./refresh-state-LFWYsunz.js");
	return skillsRefreshStateRuntimePromise;
}
function loadSkillsRemoteRuntime() {
	skillsRemoteRuntimePromise ??= import("./skills-remote-B6m1BNDH.js");
...
function resolveModelCatalogProviderScope(params) {
	...
	const addModelRef = (raw, defaultProvider) => {
		addProvider((raw ? parseModelRef(raw, defaultProvider) : null)?.provider);
	};
	...
	addModelRef(params.explicitModelOverride, params.explicitProviderOverride ?? params.defaultProvider);
	for (const raw of Object.keys(params.cfg.agents?.defaults?.models ?? {})) addModelRef(raw, params.defaultProvider);
