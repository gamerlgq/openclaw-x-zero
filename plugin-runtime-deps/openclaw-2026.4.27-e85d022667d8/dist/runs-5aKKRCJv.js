...
import { i as logMessageQueued, o as logSessionStateChange } from "./diagnostic-ZVoTn1JP.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-CIzj_PYg.js";
...
function requestEmbeddedRunModelSwitch(sessionId, request) {
	...
	if (!normalizedSessionId || !provider || !model) return false;
	...
	diagnosticLogger.debug(`model switch requested: sessionId=${normalizedSessionId} provider=${provider} model=${model}`);
	return true;
}
...
//#endregion
export { createReplyOperation as _, getActiveEmbeddedRunSnapshot as a, queueEmbeddedPiMessage as c, setActiveEmbeddedRun as d, updateActiveEmbeddedRunSnapshot as f, ReplyRunAlreadyActiveError as g, getActiveEmbeddedRunCount as h, consumeEmbeddedRunModelSwitch as i, requestEmbeddedRunModelSwitch as l, waitForEmbeddedPiRunEnd as m, abortEmbeddedPiRun as n, isEmbeddedPiRunActive as o, waitForActiveEmbeddedRuns as p, clearActiveEmbeddedRun as r, isEmbeddedPiRunStreaming as s, __testing as t, resolveActiveEmbeddedRunSessionId as u, replyRunRegistry as v };
