...
import { I as resolveProviderSystemPromptContribution, et as resolveProviderFollowupFallbackRoute } from "./provider-runtime-lXmVyAfy.js";
import { r as isSilentReplyPayloadText } from "./tokens-BIJuzXU-.js";
import { t as normalizeEmbeddedAgentRuntime } from "./runtime-cpelpx_v.js";
import { a as normalizeProviderToolSchemas, i as logProviderToolSchemaDiagnostics, n as resolveTranscriptPolicy } from "./tool-result-middleware-BNFGsl4u.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-f5NvMXJ4.js";
import { a as resolvePreparedExtraParams } from "./extra-params-WsfL6_KM.js";
...
function buildAgentRuntimeAuthPlan(params) {
	...
	const normalizedAuthProfileProvider = normalizeProviderId(params.authProfileProvider ?? params.provider);
	const aliasLookupParams = {
		config: params.config,
		workspaceDir: params.workspaceDir
	};
	const harnessAuthProvider = resolveHarnessAuthProvider(params);
	if (!params.sessionAuthProfileId && !harnessAuthProvider) return {
		providerForAuth: normalizedProvider,
		authProfileProviderForAuth: normalizedAuthProfileProvider
	};
	const providerForAuth = normalizedProvider === normalizedAuthProfileProvider ? normalizedProvider : resolveProviderIdForAuth(params.provider, aliasLookupParams);
	const authProfileProviderForAuth = normalizedProvider === normalizedAuthProfileProvider ? normalizedAuthProfileProvider : resolveProviderIdForAuth(params.authProfileProvider ?? params.provider, aliasLookupParams);
