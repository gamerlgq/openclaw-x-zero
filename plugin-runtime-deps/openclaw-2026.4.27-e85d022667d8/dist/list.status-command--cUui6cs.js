...
import { b as resolveAgentDir, i as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride } from "./agent-scope-RNt6KatQ.js";
import { r as createConfigIO } from "./io-B4W7YRox.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-WmkV2Z8L.js";
import { o as shouldEnableShellEnvFallback, t as getShellEnvAppliedKeys } from "./shell-env-Dv6Cj1cU.js";
...
import { i as ensureAuthProfileStoreWithoutExternalProfiles } from "./store-lvugMVfA.js";
import { F as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-lXmVyAfy.js";
import { t as resolveOpenClawAgentDir } from "./agent-paths-B_wzQ6Ed.js";
import { _ as resolveModelRefFromString, i as buildModelAliasIndex, m as resolveConfiguredModelRef, x as parseModelRef } from "./model-selection-shared-BAGl40FK.js";
import { u as isNonSecretApiKeyMarker, v as resolveProviderEnvApiKeyCandidates } from "./model-auth-markers-BDTl9MEF.js";
...
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-y_h14LHT.js";
import { i as getCustomProviderApiKey, l as resolveUsableCustomProviderApiKey } from "./model-auth-CsyLGY9m.js";
import { n as ensureFlagCompatibility, s as resolveKnownAgentId } from "./shared-YnyPjxBf.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-298RXdp5.js";
import { t as maskApiKey } from "./mask-api-key-Cdizu1pA.js";
import { t as loadModelsConfig } from "./load-config-BQIV37cV.js";
import { n as isRich } from "./list.format-DDJtfv8A.js";
...
function loadProviderUsageRuntime() {
	providerUsageRuntimePromise ??= import("./provider-usage-DmQckvdx.js");
	return providerUsageRuntimePromise;
}
function loadProgressRuntime() {
	progressRuntimePromise ??= import("./progress-DpplB4QN.js");
	return progressRuntimePromise;
}
function loadTerminalTableRuntime() {
	terminalTableRuntimePromise ??= import("./table-wbN6tB8F.js");
	return terminalTableRuntimePromise;
}
function loadListProbeRuntime() {
	listProbeRuntimePromise ??= import("./list.probe-DmnCgkoG.js");
...
async function modelsStatusCommand(opts, runtime) {
	...
	if (missingProvidersInUse.length > 0) {
		const { buildProviderAuthRecoveryHint } = await import("./provider-auth-guidance-BdVzCIej.js");
		runtime.log("");
