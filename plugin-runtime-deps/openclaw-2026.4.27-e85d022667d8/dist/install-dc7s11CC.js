...
import { o as unscopedPackageName, r as resolveSafeInstallDir } from "./install-safe-path-Bw-OXEL6.js";
import { t as parseFrontmatter } from "./frontmatter-BZViYttj.js";
import path from "node:path";
import fs from "node:fs/promises";
//#region src/hooks/install.ts
let hookInstallRuntimePromise;
async function loadHookInstallRuntime() {
	hookInstallRuntimePromise ??= import("./install.runtime-CWcvoYmi.js");
