...
import { i as isLoopbackHost } from "./net-DDjdGYkE.js";
import { S as resolveDefaultAgentId, b as resolveAgentDir } from "./agent-scope-RNt6KatQ.js";
import { i as getRuntimeConfig } from "./io-B4W7YRox.js";
import { n as getProviderEnvVars } from "./provider-env-vars-DOy0Czuc.js";
...
import { f as updateAuthProfileStoreWithLock, s as loadAuthProfileStoreForRuntime } from "./store-lvugMVfA.js";
...
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-6534Mgqp.js";
import { c as randomIdempotencyKey, r as callGateway } from "./call-xuTtjcDL.js";
import { m as buildMediaUnderstandingRegistry } from "./defaults-Dmvw73MC.js";
import { a as getImageMetadata } from "./image-ops-IhzyaQjL.js";
import { n as detectMime, r as extensionForMime, u as normalizeMimeType } from "./mime-srMFIJPy.js";
import { D as textToSpeech, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, d as listSpeechVoices, f as listTtsPersonas, g as resolveTtsConfig, m as resolveExplicitTtsOverrides, o as getTtsPersona, s as getTtsProvider, w as setTtsPersona } from "./tts-runtime-CUwkGwKZ.js";
import "./tts-C7C3Y01Z.js";
import "./auth-profiles-Bb8moCUr.js";
import { n as listProfilesForProvider } from "./profile-list-DRJDaM7Y.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-BMgPU1ZW.js";
import { l as saveMediaBuffer } from "./store-DpHDDFdI.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-BRxfKwzb.js";
import { a as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-B5eoKwUm.js";
import { t as resolveMemorySearchConfig } from "./memory-search-CwVTNndi.js";
import { r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-dPXq7vl5.js";
import { r as prepareSimpleCompletionModelForAgent, t as completeWithPreparedSimpleCompletionModel } from "./simple-completion-runtime-fDw3xS3T.js";
...
import { a as transcribeAudioFile, n as describeImageFileWithModel, r as describeVideoFile, t as describeImageFile } from "./runtime-BcMJWmrV.js";
import { i as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-Dc6W1BMH.js";
import { i as resolveWebFetchDefinition, r as listWebFetchProviders, t as isWebFetchProviderConfigured } from "./runtime-CM_JnJCH.js";
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command--cUui6cs.js");
...
function registerCapabilityCli(program) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-D7a3x7ou.js");
