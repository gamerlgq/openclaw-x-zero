...
import { n as isRestartEnabled } from "./commands.flags-CnEa-Qvw.js";
import { a as deferGatewayRestartUntilIdle, f as setGatewaySigusr1RestartPolicy, o as emitGatewayRestart } from "./restart-DxyVOcGR.js";
import { a as resetModelCatalogCache } from "./model-catalog-BXENBv-p.js";
import { h as getActiveEmbeddedRunCount, n as abortEmbeddedPiRun } from "./runs-5aKKRCJv.js";
import { i as disposeAllSessionMcpRuntimes } from "./pi-bundle-mcp-runtime-BZXzXJCi.js";
import "./pi-bundle-mcp-tools-DcJhmfN5.js";
import { c as getTotalQueueSize } from "./command-queue-CcuIP5Dq.js";
import { i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-1B0RBbXU.js";
import { r as resetDirectoryCache } from "./target-resolver-BY_0IvsO.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-BR_zbwwP.js";
import { _ as resolveHooksConfig } from "./hooks-PeBCC0WQ.js";
import { r as getInspectableTaskRegistrySummary } from "./task-registry.maintenance-CoV5dkSd.js";
import { r as startGatewayConfigReloader } from "./config-reload-B8Hbe_dn.js";
import { c as startGatewayChannelHealthMonitor, g as enqueueConfigRecoveryNotice, h as buildGatewayCronService, l as startGatewayCronWithLogging, m as applyGatewayLaneConcurrency, o as setCurrentSharedGatewaySessionGeneration, r as disconnectStaleSharedGatewayAuthClients, t as resolveHookClientIpConfig } from "./hook-client-ip-config-B6ymtVEi.js";
...
function createGatewayReloadHandlers(params) {
	...
	const applyHotReload = async (plan, nextConfig) => {
		...
		if (plan.restartGmailWatcher) {
			const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-BZXImUee.js"), import("./gmail-watcher-lifecycle-CRw1ZC4P.js")]);
