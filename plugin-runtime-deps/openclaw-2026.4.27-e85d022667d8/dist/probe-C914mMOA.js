...
import { n as GatewayClientRequestError, o as loadDeviceAuthToken, t as GatewayClient } from "./client-C_yF1Jx2.js";
...
import { i as READ_SCOPE } from "./operator-scopes-B0wNyvBW.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		...
		try {
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-D4HFGq-4.js");
