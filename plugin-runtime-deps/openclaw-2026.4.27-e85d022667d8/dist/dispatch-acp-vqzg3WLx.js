...
import { b as resolveAgentDir } from "./agent-scope-RNt6KatQ.js";
import { i as emitAgentEvent } from "./agent-events-Buswj6xX.js";
import { i as toAcpRuntimeError } from "./errors-B5qQp0Em.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-CZ8Q7N-w.js";
import { a as resolveAcpDispatchPolicyError, i as resolveAcpAgentPolicyError } from "./policy-D59sNK3t.js";
import { s as hasOutboundReplyContent } from "./reply-payload-f5NvMXJ4.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-GDEo7Ql1.js";
import { t as EmbeddedBlockChunker } from "./pi-embedded-block-chunker-CyPrjA-7.js";
import { a as generateSecureUuid } from "./secure-random-D3NKm3ta.js";
import { r as prefixSystemMessage } from "./system-message-uvXk7G2c.js";
import { t as createTtsDirectiveTextStreamCleaner } from "./directives-BBBQVaXp.js";
import { i as shouldCleanTtsDirectiveText, t as resolveConfiguredTtsMode } from "./tts-config-DmfJcjRy.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-bmRHXe4n.js";
import { t as hasInboundMedia } from "./inbound-media-BKhLPB1R.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-Dv0ixbqc.js";
import { a as resolveAcpThreadSessionDetailLines } from "./session-identifiers-Dy8qknbQ.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-D55Eb7ex.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-CKyyomv4.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-Dtm2eWFs.js");
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-D18gYdPH.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-DCpC1Vx5.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-C_0kSTa3.js");
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-CuiVfW58.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-DwvcCyj-.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-D18gYdPH.js");
	return dispatchAcpTtsRuntimePromise;
}
function loadDispatchAcpTranscriptRuntime() {
	dispatchAcpTranscriptRuntimePromise ??= import("./dispatch-acp-transcript.runtime-DLBEVJ5_.js");
