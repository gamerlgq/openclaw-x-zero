...
import { i as upsertAuthProfile } from "./profiles-JhylvYqI.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-C_Qhb-di.js";
import { t as enablePluginInConfig } from "./enable-CeFEiNiT.js";
import { n as openUrl } from "./browser-open-C9Pbqof7.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DArdxhnZ.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-B30CfW2K.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-Dvd0jtPO.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-Cd1DlaVl.js";
import { t as isRemoteEnvironment } from "./remote-env-Bl1Rwh0X.js";
...
let providerAuthChoiceDeps = { loadPluginProviderRuntime: async () => import("./provider-auth-choice.runtime-BwvCZDX4.js") };
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const [{ ensureOnboardingPluginInstalled }, { clearPluginDiscoveryCache }] = await Promise.all([import("./onboarding-plugin-install-DxIGfQoA.js"), import("./discovery-DTQkvSrs.js")]);
