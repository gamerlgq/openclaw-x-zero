...
import { g as recoverConfigFromJsonRootSuffix, u as readConfigFileSnapshot } from "./io-B4W7YRox.js";
import { n as formatConfigIssueLines } from "./issue-format-DPCYJ_FB.js";
import { t as note } from "./note-DRReSDjk.js";
import { n as noteIncludeConfinementWarning } from "./doctor-config-analysis-zKZPXPy2.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-D3WQxFub.js");
