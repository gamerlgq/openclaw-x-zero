...
import { m as inspectProviderToolSchemasWithPlugin, tt as resolveProviderRuntimePlugin, y as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-lXmVyAfy.js";
import "./model-selection-DGI1ibK2.js";
import { n as isGoogleModelApi, t as isGemma4ModelRequiringReasoningStrip } from "./google-BIuha9qa.js";
import { t as log$1 } from "./logger-DunA0zkP.js";
import { T as shouldPreserveThinkingBlocks } from "./provider-model-shared-C3XFO8Tx.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolveHandlers = async () => {
		...
		resolvedHandlersPromise ??= import("./agent-tool-result-middleware-loader-eKYRWju0.js").then(({ loadAgentToolResultMiddlewaresForRuntime }) => loadAgentToolResultMiddlewaresForRuntime({ runtime: ctx.runtime }));
