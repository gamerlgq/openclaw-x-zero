...
import { r as hasInterSessionUserProvenance } from "./input-provenance-Dj8S9UNT.js";
import { c as isUsageCountedSessionTranscriptFileName, i as isSessionArchiveArtifactName, n as isCompactionCheckpointTranscriptFileName } from "./artifacts-C4Ry7YwM.js";
...
import "./heartbeat-CxHCYc7v.js";
import { r as isHeartbeatUserMessage } from "./heartbeat-filter-DaEmg3YT.js";
import { n as normalizeOptionalLowercaseString, r as normalizeOptionalString, t as normalizeLowercaseStringOrEmpty } from "./string-utils-DoQjWCc3.js";
import "./query-expansion-Cic3aAyO.js";
import { i as isExecCompletionEvent } from "./heartbeat-events-filter-U2D4z_sl.js";
...
import "./openclaw-runtime-session-WvROUWxe.js";
...
function resolveWindowsSpawnProgram(params) {
	...
	throw new Error(`${path.basename(candidate.command)} wrapper resolved, but no executable/Node entrypoint could be resolved without shell execution.`);
}
