...
import { s as isDeliverableMessageChannel } from "./message-channel-BWqMq4di.js";
...
import { a as sanitizeTaskStatusText, i as formatTaskStatusTitleText } from "./task-status-DU0kyeVf.js";
import { n as requireNodeSqlite, t as configureSqliteWalMaintenance } from "./sqlite-wal-DsjvWn9p.js";
import { n as summarizeTaskRecords } from "./task-registry.summary-CETuqQCm.js";
...
function loadTaskRegistryDeliveryRuntime() {
	...
	deliveryRuntimePromise ??= import("./task-registry-delivery-runtime-DP7HEsMh.js");
...
function setTaskProgressById(params) {
	ensureTaskRegistryReady();
	const patch = {};
...
function setTaskTimingById(params) {
	ensureTaskRegistryReady();
	const patch = {};
...
function getTaskRegistrySummary() {
	ensureTaskRegistryReady();
	return summarizeTaskRecords(tasks.values());
}
function getTaskRegistrySnapshot() {
	return {
...
function findLatestTaskForOwnerKey(ownerKey) {
...
//#endregion
export { updateFlowRecordByIdExpectedRevision as $, resetTaskRegistryForTests as A, createTaskFlowForTask as B, markTaskTerminalById as C, reloadTaskRegistryFromStore as D, recordTaskProgressByRunId as E, setTaskRegistryDeliveryRuntimeForTests as F, getTaskFlowById as G, failFlow as H, setTaskRunDeliveryStatusByRunId as I, listTaskFlowsForOwnerKey as J, getTaskFlowRegistryRestoreFailure as K, setTaskTimingById as L, setTaskCleanupAfterById as M, setTaskProgressById as N, resetTaskRegistryControlRuntimeForTests as O, setTaskRegistryControlRuntimeForTests as P, setFlowWaiting as Q, updateTaskNotifyPolicyById as R, markTaskRunningByRunId as S, maybeDeliverTaskTerminalUpdate as T, findLatestTaskFlowForOwnerKey as U, deleteTaskFlowRecordById as V, finishFlow as W, resolveTaskFlowForLookupToken as X, requestFlowCancel as Y, resumeFlow as Z, listTasksForFlowId as _, finalizeTaskRunByRunId as a, listTasksForSessionKey as b, findLatestTaskForRelatedSessionKey as c, getTaskRegistrySnapshot as d, getTaskRegistrySummary as f, listTasksForAgentId as g, listTaskRecords as h, ensureTaskRegistryReady as i, resolveTaskForLookupToken as j, resetTaskRegistryDeliveryRuntimeForTests as k, findTaskByRunId as l, linkTaskToFlowById as m, createTaskRecord as n, findLatestTaskForFlowId as o, isParentFlowLinkError as p, listTaskFlowRecords as q, deleteTaskRecordById as r, findLatestTaskForOwnerKey as s, cancelTaskById as t, getTaskById as u, listTasksForOwnerKey as v, markTaskTerminalByRunId as w, markTaskLostById as x, listTasksForRelatedSessionKey as y, createManagedTaskFlow as z };
