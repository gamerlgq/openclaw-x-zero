...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-DYuOBUS_.js";
import { _ as resolveRealtimeVoiceAgentConsultTools, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, v as resolveRealtimeVoiceAgentConsultToolsAllow } from "./session-runtime-BogHyHqI.js";
import { o as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-CjD_kzdm.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-L87vww_l.js";
import { t as zod_exports } from "./zod-C2RJs7Tu.js";
import "./api-D7dO2hvl.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-BkzrVUh7.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-C5gZ1ECC.js";
import { t as resolveVoiceResponseModel } from "./response-model-CGWDVwB3.js";
import { t as isProviderStatusTerminal } from "./call-status-Hg8NcgvT.js";
import { t as getHeader } from "./http-headers-D_vxtaHl.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-COYnDcWy.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-6mdPoU2R.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-C3vVZyCj.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-BqBavmr2.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-CPnhqmpP.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-rWBvu8rj.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-DK6S6Reg.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-D6jJFE6v.js");
