...
import { n as MANIFEST_KEY } from "./legacy-names-PaIj6vU5.js";
import { n as isPathInside, t as extensionUsesSkippedScannerPath } from "./scan-paths-CdBrZLbm.js";
import { c as normalizeAgentId } from "./session-key-C6F-NnIG.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-6expXmjL.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-CgZguYzs.js");
...
function loadAuditFsModule() {
	auditFsModulePromise ??= import("./audit-fs-dS2AVCBP.js");
	return auditFsModulePromise;
}
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-BjAlNuVl.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-ClWp8Nc9.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-DlGmFEDp.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./skill-scanner-Bmbo8ymx.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-BzyRIxpT.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-DRTXVyGr.js");
