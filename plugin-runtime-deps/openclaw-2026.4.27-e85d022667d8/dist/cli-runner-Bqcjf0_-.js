...
import "./tokens-BIJuzXU-.js";
import { p as isFailoverErrorMessage, t as classifyFailoverReason } from "./errors-CoQ9mM7g.js";
import "./pi-embedded-helpers-f4IO3CdD.js";
import { i as isFailoverError, s as resolveFailoverStatus, t as FailoverError } from "./failover-error-9zkewhNf.js";
import { i as runAgentHarnessLlmOutputHook, r as runAgentHarnessLlmInputHook, t as runAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-g--XRrcl.js";
import { i as buildAgentHookConversationMessages, n as loadCliSessionHistoryMessages } from "./session-history-CDFbGBUD.js";
...
async function runCliAgent(params) {
	...
	const { prepareCliRunContext } = await import("./prepare.runtime-DahgS6Xj.js");
	const context = await prepareCliRunContext(params);
	try {
		return await runPreparedCliAgent(context);
	} finally {
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-RTe19y5Q.js");
			await closeClaudeLiveSessionForContext(context);
		}
		if (params.cleanupBundleMcpOnRunEnd === true) {
			const { closeMcpLoopbackServer } = await import("./mcp-http-CLJokqN2.js");
			await closeMcpLoopbackServer();
		}
	}
}
async function runPreparedCliAgent(context) {
	const { executePreparedCliRun } = await import("./execute.runtime-DzR5QeJG.js");
