...
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-l0VAxkh1.js";
import { h as resolveBrowserRateLimitMessage } from "./cdp.helpers-DMQRJz_c.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-CEhzBcsd.js");
