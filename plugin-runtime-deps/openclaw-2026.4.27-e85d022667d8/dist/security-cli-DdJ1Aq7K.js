...
import { d as createIcaclsResetCommand, f as formatIcaclsResetCommand } from "./audit-fs-BIdj7WRc.js";
import { c as normalizeAgentId } from "./session-key-C6F-NnIG.js";
import { S as resolveDefaultAgentId } from "./agent-scope-RNt6KatQ.js";
import { i as getRuntimeConfig, r as createConfigIO } from "./io-B4W7YRox.js";
...
import { s as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-CQsa2CXb.js";
import { t as formatHelpExamples } from "./help-format-CmO6sKiH.js";
import { t as runSecurityAudit } from "./audit-BaqcSxzL.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-ByIwEzas.js");
