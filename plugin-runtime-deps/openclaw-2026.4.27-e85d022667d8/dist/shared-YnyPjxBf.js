...
import { _ as resolveModelRefFromString, i as buildModelAliasIndex, v as legacyModelKey, y as modelKey } from "./model-selection-shared-BAGl40FK.js";
...
function upsertCanonicalModelConfigEntry(models, params) {
	...
	if (legacyKey && models[legacyKey]) models[key] = {
		...models[legacyKey],
		...models[key],
		params: {
