#!/usr/bin/env node
import { a as formatUncaughtError } from "./errors-g8SYDTCe.js";
import { r as runFatalErrorHooks } from "./fatal-error-hooks-4xzPL8p8.js";
import { t as isMainModule } from "./is-main-BEaTwLZn.js";
import { r as isBenignUncaughtExceptionError, s as isUncaughtExceptionHandled, t as installUnhandledRejectionHandler } from "./unhandled-rejections-CzVfidKB.js";
...
if (!isMain) ({applyTemplate, createDefaultDeps, deriveSessionKey, describePortOwner, ensureBinary, ensurePortAvailable, getReplyFromConfig, handlePortError, loadConfig, loadSessionStore, monitorWebChannel, normalizeE164, PortInUseError, promptYesNo, resolveSessionKey, resolveStorePath, runCommandWithTimeout, runExec, saveSessionStore, waitForever} = await import("./library-Cg4QFV8j.js"));
if (isMain) {
