...
import { l as resolveDefaultSecretProviderAlias } from "./ref-contract-DtvCiPbj.js";
import { n as defaultRuntime, r as writeRuntimeJson } from "./runtime-CIJX7ulQ.js";
import { t as assertSupportedRuntime } from "./runtime-guard-CQFUyBrZ.js";
import "./daemon-runtime-C4_-bMd5.js";
import { t as resolveConfiguredSecretInputString } from "./resolve-configured-secret-input-string-Bd5tVNr3.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-BqxGpg3O.js";
import { u as readConfigFileSnapshot } from "./io-B4W7YRox.js";
import { r as replaceConfigFile } from "./mutate-Bnr0cx3h.js";
import { t as randomToken } from "./random-token-BNlOknWh.js";
import "./config-CopVFMnG.js";
import { t as resolveControlUiLinks } from "./control-ui-links-yXKHx3OU.js";
import { t as WizardCancelledError } from "./prompts-DLLnQBbr.js";
import { t as createClackPrompter } from "./clack-prompter-DI1GTX4M.js";
import { n as logConfigUpdated } from "./logging-DC5Z7XZc.js";
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BSh6qRVp.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-D8i5nrxQ.js";
import { t as runSetupWizard } from "./setup-B9PtdZS_.js";
import { i as applySkipBootstrapConfig, r as applyLocalSetupWorkspaceConfig } from "./onboard-config-BjxvKYLd.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-D8CvnbdN.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-B3BztkHN.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-C5vX5fs3.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-Dk_Z7IxK.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-HcwAiE68.js");
