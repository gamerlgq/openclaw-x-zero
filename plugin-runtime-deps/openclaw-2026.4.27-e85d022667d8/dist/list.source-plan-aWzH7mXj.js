...
async function planAllModelListSources(params) {
	...
	const { loadStaticManifestCatalogRowsForList, loadSupplementalManifestCatalogRowsForList } = await import("./list.manifest-catalog-Dr_SV1Nj.js");
	if (!params.providerFilter) {
		const { loadProviderIndexCatalogRowsForList } = await import("./list.provider-index-catalog-BxsZ9QoE.js");
		return createSourcePlan({
			kind: "registry",
	...
	const { hasProviderStaticCatalogForFilter } = await import("./list.provider-catalog-BrztvDP-.js");
